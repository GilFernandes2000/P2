...
public class SocialNetwork {
  ...
  private void extendRequestArray() {
    FriendshipRequest[] req = new FriendshipRequest[requests.length+sizeExpansion];
    assert req.length > requests.length;
    System.arraycopy(requests, 0, req, 0, numRequests);
    requests = req;
  }
